        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div id="info" class="bg-dark col">
                    <img src="godzina.php" alt="Brak Danych" id="zdj">
                    <img src="miesiac.php" alt="Brak Danych" id="zdj">
                    <img src="rok.php" alt="Brak Danych" id="zdj">
                </div>
            </div>
            <?php unset($_COOKIE['idw'], $_COOKIE['dzien'], $_COOKIE['miesiac'], $_COOKIE['rok']); ?>
        </div>
    </body>
</html>